...
<div class="auth-layout-wrap" >
 ...
 <div class="container">
	...
	<li class="nav-item">
		<a class="nav-link  active {{request () -> is('/ATCForm1.jsp') ? 'active' : null }}" href="ATCForm1.jsp" role="tab">ATC Form</a>
	</li>
                    ...
                    <div class="row gx-0 align-items-center justify-content-between">
                        <div class="col-12">
                          ...
                          ></span>
                                        ...
                                        />
                                         -->
                                         <select class="form-control" id="TherapeuticClass" name="TherapeuticClass">
                                            <option value="Select Therapeutic Class" disabled selected hidden>Select Therapeutic Class</option>
                                              <%for(ATC_Model atc : atcList){ %>
                        ...
                        <div class="input-group">
                          ...
                          ></span>
                                     <!--   <input onkeydown="removeValidation()"
                                               ...
                                               required
                                        />  -->
                                       <select class="form-control" id="ClinicalClass" name="ClinicalClass">
                                            <option value="Select Clinical Class" disabled selected hidden>Select Clinical Class</option>
                                              <%for(ATC_Model atc : atcList){ %>
                          ...
                          ></span>
                                     <!--    <input onkeydown="removeValidation()"
                                               ...
                                               required
                                        /> -->
                                        <select class="form-control" id="AnatomicalClass" name="AnatomicalClass">
                                            <option value="Select Anatomical Class" disabled selected hidden>Select Anatomical Class</option>
                                              <%for(ATC_Model atc : atcList){ %>
