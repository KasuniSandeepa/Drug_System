...
<a href="ATCFormEntry.jsp"><input id="g" type="button" class="btn btn-primary"
										name="" value="Add a new ATC Record" style="float: right;"/></a>
                            <div class="table-responsive">
                                <table class="display table table-striped table-bordered"  id="deafult_ordering_table_aa"
                                  ...
                                  <% for(ATC_Model atc : atcList){%>
				                   ...
				                   <c:url value="EditATCFormEntry.jsp" var="updatedATC">
