                          ...
                          >Notes</span>
                                ...
                                <br>
                                  <input name="c_page" value="drug_update" hidden>
						                  ...
						                  <%if(isd.getSTATUS()==null ||isd.getSTATUS().equals("0") || status.equals("2") ) {%>
			                            
			                                  <input type="button"  class="btn btn-primary " id="approveBtn2"  onclick="approveDrug()" value="Approve" style="visibility:visible">
			                                  
			                     
			                            	<%} else if(isd.getSTATUS().equals("1") ){%>
			                            	
			                            	  <input type="button"  class="btn btn-primary " id="approveBtn3"  onclick="disapproveDrug()" value="Approved" style="visibility:visible">
			                            	...
			                            	<div class="mt-3 text-right col-md-10" style="margin-top: -45px !important;   margin-left: 100px ">
			                            	    ...
			                            	    <input type="button" class="btn btn-primary " id="deletebtn" value="Delete" onclick="deleteDrug()";>
    ...
    function isdGenericDropDown() {
     ...
     document.addEventListener('click', function(e) {
  		...
  		if (e.target && e.target.id == 'main') {
  			console.log("I am hereeeeeeeeeee step-1");
