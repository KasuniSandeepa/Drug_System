...
<div class="auth-layout-wrap" >
  ...
  <div class="col-md-12 mb-4">
	...
	<li class="nav-item">
		<a class="nav-link   active {{request() -> is('/IMCForm2.jsp') ? 'active' : null }}"  href="IMCRecords.jsp" role="tab">IMC Form</a>
	</li>
	<li class="nav-item">
		<a class="nav-link  {{request () -> is('/ISDForm2.jsp') ? 'active' : null }}" href="ISDRecords.jsp" role="tab">ISD Form</a>
	</li>
	<li class="nav-item">
...
<div class="tab-content">
																	...
																	<div class="form-group mb-2 col-md-12" >
																		<div class="input-group">
																			<span class="input-group-text  col-md-3" id="basic-addon3" STYLE="font-weight:bold"><span
																				...
																				id="importer" name="Importer" autocomplete="off" 	 onchange="generateImcCode();"/>
    ...
    <option value="">Select the Importer</option> -->
																			...
																			<option value="<%=importer%>"
																				onclick="setImporter(this.value);hideDropDown();generateImcCode();"><%=importer%></option>
																			<%
																			}
																			%>
																			<!--  </select> -->
																	...
																	<div class="form-group mb-2 col-md-12">
																		<div class="input-group">
																			<span class="input-group-text col-md-3" id="basic-addon3" STYLE="font-weight:bold"><span
																				...
																				id="manufacturer" name="Manufacturer" 	onchange="generateImcCode();"
																		...
																		<div id="myDropdown_m" class="dropdown-content">
																			...
																			for (IMC manufacturer : IMCListAll) {
																				if (manufacturerList.contains(manufacturer.getMANUFACTURER())) {
																					//do nothing
																				} else {
																					if(manufacturer.getSTATUS().equals("1")){
																						manufacturerList.add(manufacturer.getMANUFACTURER());
																					}
																				}
																			}
