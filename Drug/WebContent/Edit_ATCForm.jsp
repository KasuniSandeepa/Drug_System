                        ...
                        <div class="col-12">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <img class="pt-1" src="dist-assets/images/dlf.pt-plus-sign-png-110969.png" style="width: 10%"
                                     id="logo-sprig" alt=""/>
                                  <br>	<br>	  
                                <h1 class="mb-0 h5">DRUG INFORMATION UPDATE/APPROVE - ATC FORM</h1>
                            </div>
                                ...
                                <br>
                                  <input name="c_page" value="atc_drug_update" hidden>
						                  ...
						                  <%if(status==null ||status.equals("0")|| status.equals("2")) {%>
			                                  ...
			                                  <input type="button"  class="btn btn-primary " id="approveBtn2"  onclick="approveATCDrug()" value="Approve" style="visibility:visible">
			                                  
			                     
			                            	<%} else if(status.equals("1") ){%>
			                            	
			                            	  <input type="button"  class="btn btn-primary " id="approveBtn3"  onclick="disapproveATCDrug()" value="Approved" style="visibility:visible">
            ...
            if (data == 'EXE') {
                ...
                if (data) {
                	...
                	swal({
        			    ...
        			    window.location = "ATCApproval.jsp";
	        		  });
                    $('#subBtn').show(); 
                    console.log("okkkk");
