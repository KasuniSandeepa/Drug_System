...
<!-- 	<a href="controller/DrugContrller.jsp?action=generateAllImcCodes"><input type="button" class="btn btn-primary" onclick="generateAllImcCodes();"
										...
										<input id="g" type="button" class="btn btn-primary" onclick="generateAllImcCodes();"
										name="" value="Generate IMC Codes for Records Not Have IMC Records" style="float: right;"/>
                                  ...
                                  <% for(IMC imc : imcList){%>
			                         ...
			                         <td> <button type="button" class="btn btn-labeled btn-danger">
			                            ...
			                            <td>
				                          ...
				                          <c:url value="Edit_IMCForm.jsp" var="updatedIMC">
