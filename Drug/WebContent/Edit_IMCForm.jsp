...
--%>
<%@page import="drugfilter.model.IMC"%>
...
<div class="auth-layout-wrap" >
  ...
  <div class="col-md-12 mb-4">
	...
	<li class="nav-item">
		<a class="nav-link    active  {{request() -> is('/IMCForm1.jsp') ? 'active' : null }}"  href="IMCApproval.jsp" role="tab">IMC Approval</a>
	</li>
	<li class="nav-item">
...
<div class="tab-content">
                        ...
                        <div class="col-12">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <img class="pt-1" src="dist-assets/images/dlf.pt-plus-sign-png-110969.png" style="width: 10%"
                                     id="logo-sprig" alt=""/>
                                  <br>	<br>	  
                                <h1 class="mb-0 h5">DRUG INFORMATION UPDATE/APPROVE - IMC FORM</h1>
                            </div>
    ...
    <option value="">Select the Importer</option> -->
																			...
																			<option value="<%=i%>"
																				onclick="setImporter(this.value);hideDropDown();"><%=i%></option>
																			<%
																			}
																			%>
																			<!--  </select> -->
                        ...
                        <div class="input-group">
                          ...
                          >Manufacturer</span>
                                     ...
                                     <div id="myDropdown_m" class="dropdown-content">
																			...
																			<%--   <a href="#"   onclick="x()"><%=importer.getIMPORTER() %></a> --%>
																			<option value="<%=man%>"
																				onclick="setManufacturer(this.value);hideManufacturerDropDown();"><%=man%></option>
																			<%
																			}
																			%>
                          ...
                          >Country</span>
                                        ...
                                        /> 
                                             <div class="dropdown">
																				<input type="button"  onclick="myFunction_c()" class="dropbtn" value="Select"></button>
                                ...
                                <br>
                                  <input name="c_page" value="imc_update" hidden>
						                  ...
						                  <%if(status==null ||status.equals("0") || status.equals("2") ) {%>
			                                  ...
			                                  <input type="button"  class="btn btn-primary " id="approveBtn2"  onclick="approveIMC()" value="Approve" style="visibility:visible">
			                                  
			                     
			                            	<%} else if(status.equals("1") ){%>
			                            	
			                            	  <input type="button"  class="btn btn-primary " id="approveBtn3"  onclick="disapproveIMC()" value="Approved" style="visibility:visible">
