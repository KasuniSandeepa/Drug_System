...
<div class="app-admin-wrap layout-sidebar-large">
 ...
 -->
  <div>
	...
	<li class="nav-item">
		<a class="nav-link   active {{request () -> is('/ISDForm2.jsp') ? 'active' : null }}" href="Approve.jsp" role="tab">ISD Approval</a>
	</li>
	<li class="nav-item">
		<a class="nav-link  {{request () -> is('/ATCForm.jsp') ? 'active' : null }}" href="ATCApproval.jsp" role="tab">ATC Approval</a>
	</li>
			                         ...
			                         <td> <button type="button" class="btn btn-labeled btn-danger">
			                            ...
			                            <%--   <form action="controller/DrugContrller.jsp">
          								...
          								<%} %>
				                            ...
				                            <c:url value="Edit_ISDForm1.jsp" var="updatedDrug">
