...
<body>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div id="smartwizard">
								...
								<ul style="margin-left: 360px; margin-right: 360px;">


									<li style="margin-left: 150px;"><a href="#step-1">IMC
											Data<br /> <small></small>
									</a></li>
    ...
    <option value="">Select the Importer</option> -->
																					...
																					<option value="<%=importer%>"
																						onclick="setImporter(this.value);" ><%=importer%></option>
																					<%
																					}
																					%>
																					<!--  </select> -->
															...
															<form id="unasampor" name="unasampor" action="#">
																...
																<div class="input-group">
																	...
																	<div class="form-group mb-2 col-md-12">
																		<div class="input-group">
																			<span class="input-group-text" id="basic-addon3"><span
																				class="fas fa-user"></span></span> <select
